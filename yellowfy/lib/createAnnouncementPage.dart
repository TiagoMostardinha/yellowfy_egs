    ...
    Future<void> postAnnouncement(BuildContext context) async {
      try {
        ...
        Announcement announcement = Announcement(
          userId: userName, // keep it like this
        ...
        debugPrint('SHOW THE LATS AND LONGS' + announcement.coordinates.latitude.toString() + ' ' + announcement.coordinates.longitude.toString());
